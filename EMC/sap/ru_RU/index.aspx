                        ...
                        <div class="slider">
                           <div class="slide bkg-grad">
                              <figure class="competitor-logo">
                                 ...
                                 <figcaption>
                                    <a class="btn" href="https://ciwiki.emc.com/xwiki/wiki/ciwiki/view/Companies/SAP" target="competitive-portal">SAP на портале Competitive Intelligence</a>
                              ...
                              <p>Это специализированные подразделения, отвечающие за приложения SAP и разработку, внедрение и ежедневную эксплуатацию инфраструктуры, а также за предложение рекомендуемых изменений в конструкцию ландшафта SAP.</p>
                                 ...
                                 <h5>Вопросы, которые следует задать</h5>
                                    <ul class="cards-list">
                                       ...
                                       <li class="closed">
                                          <div class="card-title">Каковы ваши планы насчет SAP HANA? Какие преимущества вы ожидаете получить?</div>
                  ...
                  <div class="panel-content">
                     <ul class="play-choices">
                        ...
                        <li data-play="cloud-enabled-infrastructure">
                           ...
                           <p>EMC может помочь заказчикам SAP консолидировать ИТ-ресурсы, выполнить миграцию в среду x86, оптимизировать виртуализацию, а также стандартизировать и автоматизировать ИТ с помощью конвергентной инфраструктуры.</p>
                        </li>
