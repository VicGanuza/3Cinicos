...
((function ($) {
    ...
    $.fn.perfectScrollbar = function (suppliedSettings, option) {
        ...
        var $this = $(this).addClass('ps-container'),
            ...
            $scrollbutton_up = $("<div class='ps-scrollbutton-top'></div>").appendTo($this),
            $scrollbutton_down = $("<div class='ps-scrollbutton-bottom'></div>").appendTo($this),
            container_width,
            container_height,
            content_width,
            content_height,
        ...
        var updateContentScrollTop = function () {
            ...
            $scrollbutton_up.css({ top: $this.scrollTop(), right: $this.scrollLeft() });
            $scrollbutton_down.css({ bottom: -$this.scrollTop(), right: $this.scrollLeft() });
        };
        ...
        //
        var bindButtonsHandler = function () {
            $scrollbutton_up.bind('mouseenter', function () {
                var self = $this;
            ...
            $scrollbutton_down.bind('mouseenter', function () {
                var self = $(this);
                this.iid = setInterval(function () {
                    $this.scrollTop($this.scrollTop() + 10);
                    updateBarSizeAndPosition();
