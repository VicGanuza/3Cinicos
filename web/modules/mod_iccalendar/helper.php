...
class cal
{
	...
	function __construct ($data, $t_calendar, $t_day, $nav, $mon, $tue, $wed, $thu, $fri, $sat, $sun, $firstday, $bgcolor, $bgimage, $bgimagerepeat, $na,$nb,$nc,$nd,$ne,$nf,$ng,$moduleclass_sfx,$modid,$template,$items)
	{
		$this->data=$data;
